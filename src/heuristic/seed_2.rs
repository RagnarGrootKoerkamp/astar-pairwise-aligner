...
impl Heuristic for SH2 {
    type Instance<'a> = SH2I;

    fn build<'a>(&self, a: Seq<'a>, b: Seq<'a>, alphabet: &Alphabet) -> Self::Instance<'a> {
        SH2I::new(a, b, alphabet, *self)
    }
...
impl SH2I {
    fn new(a: Seq, b: Seq, alph: &Alphabet, params: SH2) -> Self {
...
impl<'a> HeuristicInstance<'a> for SH2I {
