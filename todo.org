...
** TODO Fixed k performs better than dynamic k for unordered
...
Could be fixed by also pruning by match-end, orby clustering matches.
...
| 0.05 | 0 | 14 |                                                     |
|  0.1 | 1 | 16 | for simplicity, fix m=1                             |
|  0.2 | 1 | 11 | 12 is better at large n, but 11 consistent with CSH |
